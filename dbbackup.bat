...
SET PGPASSWORD=arch8262
SET db_name=guesthouse
SET file_format=c
SET host_name=localhost
SET user_name=guesthouse
SET pg_dump_path="C:\Program Files\PostgreSQL\10\bin\pg_dump.exe"  
SET target_backup_path=C:\guesthousebackup\
...
%pg_dump_path% --host=%host_name% -p 8000 -U %user_name% -F d -b -v --format=%file_format%  %other_pg_dump_flags% -f %target_backup_path%%BACKUP_FILE%  %db_name% 
